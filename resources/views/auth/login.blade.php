...
<body>
  <section class="signup-section">
    <div class="signup-container">
      <form class="signup-form" action="{{ route('loginAffiliate') }}" method="POST">
        @csrf
        <h2>Login Daywell!</h2>
        @if ($errors->any())
            <div style="color: red">
        ...
        <input type="password" name="password" placeholder="Password" required aria-label="Password" minlength="6" />
